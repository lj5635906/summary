...
@EnableDubbo
@MapperScan("com.summary.biz.search.mapper")
public class AppSummarySearch implements ApplicationRunner, DisposableBean {
    private static ConfigurableApplicationContext ctx;

    public static void main(String[] args) {
        // No Root logger was configured, creating default ERROR-level Root logger with Console appen
        System.setProperty("nacos.logging.default.config.enabled", "false");
        ctx = SpringApplication.run(AppSummarySearch.class, args);
