...
public class ElasticsearchConfig {
    ...
    @Bean
    public ElasticsearchTransport elasticsearchTransport(ElasticsearchProperties elasticsearchProperties) {
        ...
        return new RestClientTransport(restClient(elasticsearchProperties), jacksonJsonpMapper);
    }

    @Bean
    public ElasticsearchClient elasticsearchClient(ElasticsearchProperties elasticsearchProperties) {
        return new ElasticsearchClient(elasticsearchTransport(elasticsearchProperties));
    }
