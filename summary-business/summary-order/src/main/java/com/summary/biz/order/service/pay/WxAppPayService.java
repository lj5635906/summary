...
public class WxAppPayService extends AbstractPayService {
    ...
    public WxAppPayService(ThirdPayService thirdPayService, OrderService orderService, OrderPaymentService orderPaymentService, OrderPaymentItemService orderPaymentItemService) {
    ...
    protected String doThirdPay(OrderPayParam param, OrderDO order, PayWayEnum payWay) {
        ...
        // 下单
        WxPayAppOrderResponse response = thirdPayService.pay(payParam);
