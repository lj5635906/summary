 ...
 */
@Component
public class WxNativePayService extends AbstractPayService {

    private final ThirdPayService thirdPayService;

    public WxNativePayService(ThirdPayService thirdPayService, OrderService orderService, OrderPaymentService orderPaymentService, OrderPaymentItemService orderPaymentItemService) {
    ...
    protected String doThirdPay(OrderPayParam param, OrderDO order, PayWayEnum payWay) {
        ...
        // 下单
        WxPayNativeOrderResponse response = thirdPayService.pay(payParam);
